...
float   MPUtemperature;    // Stores the real internal chip temperature in degrees Celsius
 ...
 */
    ...
    MPUtemperature = ((float) tempCount) / 333.87 + 21.0; // Temperature in degrees Centigrade
